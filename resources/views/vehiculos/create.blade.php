                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('vehiculos.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="tipo" type="text" class="form-control @error('tipo') is-invalid @enderror" name="tipo" required autocomplete="tipo">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="puestos" type="number" class="form-control @error('puestos') is-invalid @enderror" name="puestos" required autocomplete="puestos">
