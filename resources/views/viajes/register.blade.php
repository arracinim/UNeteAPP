                    ...
                    @if(sizeof($vehiculos)>0)
                        <div class="card-body">
                            <form method="POST" action="{{ route('viajes.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="color"
                                           class="col-md-4 col-form-label text-md-right">{{ __('Punto de encuentro') }}</label>

                                    <div class="col-md-6">
                                        <input id="punto_de_encuentro" type="text"
                                               class="form-control @error('punto_de_encuentro') is-invalid @enderror"
                                ...
                                <div class="form-group row">
                                    <label for="puestos_disponibles"
                                           class="col-md-4 col-form-label text-md-right">{{ __('Puestos disponibles') }}</label>

                                    <div class="col-md-6">
                                        <input id="puestos_disponibles" type="number"
                                               class="form-control @error('puestos_disponibles') is-invalid @enderror"
                                ...
                                <div class="form-group row">
                                    <label for="origen"
                                           class="col-md-4 col-form-label text-md-right">{{ __('Origen') }}</label>

                                    <div class="col-md-6">
                                        <select id="origen" class="form-control @error('origen') is-invalid @enderror"
                                                name="origen">
                                            <option>-</option>
                                            <option>Minas</option>
                                ...
                                <div class="form-group row">
                                    <label for="destino"
                                           class="col-md-4 col-form-label text-md-right">{{ __('Destino') }}</label>

                                    <div class="col-md-6">
                                        <select id="destino" class="form-control @error('destino') is-invalid @enderror"
                                                name="destino">
                                            <option>-</option>
                                            <option>Minas</option>
                                            <option>Volador</option>
